...
const content: Record<Locale, HowItWorksContent> = {
  en: {
    ...
    heroSubtitle:
      'Most AI tools just pass your prompt to an API and hope for the best. Soleri is the other 95%: the six systems that make the model\'s output useful.',
    sections: [
      {
        title: 'Six systems, one engine.',
        subtitle: 'Turn on what your agent needs. Leave the rest off.',
        text: 'The Vault stores what your agent learns. The Brain figures out what\'s worth keeping. As knowledge grows, the Curator cleans up the mess. The Planner gives work structure. Memory carries context between sessions, and Governance sets the quality rules. Run all six or just the ones you need.',
...
<span class="hl">Agent:</span>   Based on what worked before:
      ...
      },
      {
        ...
        text: 'The Brain tracks what gets used, so useful stuff rises and stale stuff fades. The Curator catches duplicates and contradictions on its own. And Governance lets you control what gets shared with the team versus what stays private.',
...
<span class="cmt">Works with:</span> Claude Code \u00B7 Cursor \u00B7 Codex \u00B7 OpenCode`,
  ...
  uk: {
    ...
    heroTitle: 'Рушій, не обгортка.',
    heroSubtitle:
      'Більшість AI-інструментів просто передають твій промпт в API і сподіваються на краще. Soleri -- це решта 95%: шість систем, які роблять вивід моделі корисним.',
    sections: [
      {
        title: 'Шість систем, один рушій.',
        subtitle: 'Увімкни те, що потрібно агенту. Решту залиш вимкненим.',
        text: 'Vault зберігає те, що агент вивчає. Brain визначає, що варто тримати. Коли знань стає більше, Curator прибирає безлад. Planner дає роботі структуру. Memory переносить контекст між сесіями, а Governance встановлює правила якості. Запускай всі шість або лише ті, що потрібні.',
...
<span class="hl">Агент:</span>   На основі того, що спрацювало:
      ...
      },
      {
        ...
        text: 'Brain відстежує, що використовується, тому корисне піднімається, а застаріле згасає. Curator ловить дублікати і протиріччя сам. А Governance дозволяє контролювати, що ділиться з командою, а що залишається приватним.',
...
<span class="cmt">Працює з:</span> Claude Code \u00B7 Cursor \u00B7 Codex \u00B7 OpenCode`,
  ...
  it: {
    ...
    heroTitle: 'Un motore, non un wrapper.',
    heroSubtitle:
      'La maggior parte degli strumenti AI passano il tuo prompt a un\'API e sperano per il meglio. Soleri è l\'altro 95%: i sei sistemi che rendono l\'output del modello utile.',
    sections: [
      {
        title: 'Sei sistemi, un motore.',
        subtitle: 'Attiva quello che serve al tuo agente. Lascia spento il resto.',
        text: 'Il Vault conserva quello che il tuo agente impara. Il Brain capisce cosa vale la pena tenere. Man mano che la conoscenza cresce, il Curator fa pulizia. Il Planner dà struttura al lavoro. Memory porta il contesto tra le sessioni, e Governance imposta le regole di qualità. Usa tutti e sei o solo quelli che ti servono.',
...
<span class="hl">Agente:</span>  In base a cosa ha funzionato prima:
      ...
      },
      {
        ...
        text: 'Il Brain traccia cosa viene usato, quindi le cose utili salgono e quelle vecchie svaniscono. Il Curator intercetta duplicati e contraddizioni da solo. E Governance ti permette di controllare cosa condividere col team e cosa tenere privato.',
