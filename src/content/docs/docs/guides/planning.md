...
Beyond storing knowledge, your agent can plan work, track execution, and learn from the results.
...
The two-gate system means the plan gets approved first, then each task gets worked on individually. The agent won't skip ahead or make assumptions about what you want.
...
When a plan completes, the agent:
...
_Previous: [Code Review with Your Agent](/docs/guides/code-review/). Next: [Capabilities](/docs/capabilities/) for the full list of things your agent can do._
