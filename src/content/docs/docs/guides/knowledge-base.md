...
description: 'What to capture, how to organize it, and how to make your agent useful over time.'
---
...
As your knowledge base grows, search gets more useful. The agent ranks results by relevance, severity, and how often each pattern has been referenced:
...
The best time to capture knowledge is right when you learn it. When you fix a bug, make a decision, or discover a better approach, capture it then. Don't save it for later. Later never comes.
