...
description: 'Why developing with a learning agent is different, and how to get the most out of it.'
---
...
This changes your workflow in a few concrete ways:
...
This is the feedback loop that drives it:
...
- Repeated workflows like migrations, component creation, deployments
...
See the [Success Story](/docs/guides/dashboard/) for a concrete example of this in action, a team going from blank slate to 50+ patterns in 20 days.
