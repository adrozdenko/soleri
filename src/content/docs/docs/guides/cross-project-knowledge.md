...
The result is that when anyone on the team captures a pattern, it's available to everyone through cross-project search. Knowledge stops being trapped in individual heads.
