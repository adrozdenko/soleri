...
|--------|---------------|
| design | *Ready for knowledge capture* |
| component | *Ready for knowledge capture* |
| figma | *Ready for knowledge capture* |
...
Salvador:  Created plan "Add Caching Layer" with 4 tasks:
